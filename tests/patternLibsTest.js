...
let actualOutput_filled_20_5 = Rectangle({ type:"filled", width:20, height:5 });
...
let actualOutput_filled_5_5 = Rectangle({ type:"filled", width:5, height:5 });
...
let actualOutput_filled_2_2 = Rectangle({ type:"filled", width:2, height:2 });
...
let actualOutput_empty_2_3 = Rectangle({ type:"filled", width:2, height:3 });
...
let actualOutput_empty_5_5 =  Rectangle({ type:"empty", width:5, height:5 });
...
let actualOutput_empty_20_5 = Rectangle({ type:"empty", width:20, height:5 });
...
let actualOutput_empty_2_2 = Rectangle({ type:"empty", width:2, height:2 });
...
let actualOutput_alternate_2_2 = Rectangle({ type:"alternating", width:2, height:2 });
...
let actualOutput_alternate_5_5 = Rectangle({ type:"alternating", width:5, height:5 });
...
let actualOutput_alternate_3_3 = Rectangle({ type:"alternating", width:3, height:3 });
...
let actualOutput_alternate_20_5 = Rectangle({ type:"alternating", width:20, height:5 });
...
let actualOutput_filled_5 = Diamond({ type:"filled", size:5 });
...
let actualOutput_filled_7 = Diamond({ type:"filled", size:7 });
...
let actualOutput_empty_5 = Diamond({ type:"hollow", size:5 });
...
let actualOutput_empty_7 = Diamond({ type:"hollow", size:7 });
...
let actualOutput_angled_5 = Diamond({ type:"angled", size:5 });
...
let actualOutput_angled_7 = Diamond({ type:"angled", size:7 });
